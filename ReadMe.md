...
Data can be downloaded [here](https://www.kaggle.com/rohitrox/healthcare-provider-fraud-detection-analysis).
...
The final model suggests that insurers can fight insurance fraud by closely monitoring:
